...
def main():
    ...
    while True:
        ...
        if money > 0:
            question_fuel = input("Do you want to buy fuel for range? (y/n): ").upper()
        ...
        input("\033[32mPress Enter to continue...\033[0m")
        if len(airport1) == 0:
            print("You are out of fuel range. Game over.")
            print(f"you have left {money} and co2 {allocated_co2:.0f} remaining ")
